...
[0] = KEYMAP_GRID( /* Reed */
  ...
  LCTL,  FN7, LALT, LGUI,  FN2,  FN6,      SPC,  FN1, LEFT, DOWN,   UP, RGHT),

[1] = KEYMAP_GRID( /* Reed GAMING */
  ESC,     Q,    W,    E,    R,    T,        Y,    U,    I,    O,    P, BSPC,
  TAB,     A,    S,    D,    F,    G,        H,    J,    K,    L, SCLN, QUOT,
  LSFT,    Z,    X,    C,    V,    B,        N,    M, COMM,  DOT, SLSH,  FN5,
...
[4] = KEYMAP_GRID( /* Reed MOUSE */
  TRNS, TRNS, TRNS, TRNS, TRNS, TRNS,     WH_L, WH_D, WH_U, WH_R, TRNS, TRNS,
  TRNS, TRNS, TRNS, TRNS, TRNS, TRNS,     MS_L, MS_D, MS_U, MS_R, TRNS, TRNS,
  TRNS, TRNS, TRNS, TRNS, TRNS, TRNS,     TRNS, TRNS, TRNS, TRNS, TRNS, TRNS,
  TRNS, FN7, TRNS, TRNS, TRNS, BTN1,     BTN3, BTN2, TRNS, TRNS, TRNS, TRNS),
};
const uint16_t PROGMEM fn_actions[] = {
    [1] = ACTION_LAYER_MOMENTARY(2),  // RAISE TO LAYER 2
    [2] = ACTION_LAYER_MOMENTARY(3),  // LOWER TO LAYER 3
    ...
    [7] = ACTION_LAYER_MOMENTARY(4),  // ACTIVATE MOUSE LAYER

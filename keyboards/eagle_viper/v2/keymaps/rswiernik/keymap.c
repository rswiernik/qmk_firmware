...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = KEYMAP(\
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                KC_SPC,                KC_NO,   KC_NO,   KC_RCTL, KC_RGUI, KC_RCTL),
    /* Function Layer 1, Useful things */
    [1] = KEYMAP(\
        ...
        MO(2), KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS, KC_END,  KC_PGDN, KC_DOWN,  KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS,                     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
    /* Function Layer 2, no as useful things (leds, reset button)*/
    [2] = KEYMAP(\
        RESET,   KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7,        KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  RGB_VAD, RGB_VAI,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RESET,   KC_TRNS, KC_TRNS,   KC_TRNS, RGB_RMOD,RGB_TOG, RGB_MOD, KC_TRNS, KC_TRNS, KC_TRNS,
